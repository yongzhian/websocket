...
<script src="<%=path %>/js/channel.js"></script> 
<style type="text/css">
* {
	margin: 0;
	padding: 0;
...
<body ondblclick="fullScreen()">
	<div class="browser" style="border:1px yellow solid" >对不起暂时只支持google chrome浏览器！</div>
	...
	<div id="footer" style="border:1px blue solid">--------</div>
